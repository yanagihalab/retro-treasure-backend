...
func main() {
	...
	mux.Handle("GET /api/cards/archive", middleware.RequireAuth(repo, http.HandlerFunc(cardH.Archive)))
	...
	mux.HandleFunc("GET /api/checkpoints/master", checkpointH.Master)
